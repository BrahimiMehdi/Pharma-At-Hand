...
const Header = () => {
  ...
  return (
    <header ref={bigHeaderBg}  className="flex z-20 justify-center sm:justify-between w-screen px-6 h-[80px] items-center fixed">
        <div>
            <LinkS className="text-light-200 text-3xl font-bold cursor-pointer" to="/">Pharma At Hand</LinkS>
        </div>
        <div ref={headerBg} className="hidden sm:flex sm:items-center sm:justify-around h-[70%] transition-all duration-300 hover:bg-light-200 w-[50%] z-10 bg-light-200 rounded-br-3xl rounded-tl-3xl">
