...
const Header = () =>  {
    ...
    return (
      ...
      >
        ...
        <FaBars onClick={changeNav} className="sm:hidden text-2xl ml-12 text-dark-100 cursor-pointer" />
        <div onClick={changeNav} ref={navMenu} className="absolute hidden top-0 text-light bg-light w-full  z-50 h-screen sm:hidden">
